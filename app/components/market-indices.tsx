...
export function MarketIndices({ indices, showBackground = true, onIndexClick }: MarketIndicesProps) {
  return (
    <>
      ...
      <div className="fixed left-16 right-0 bottom-0 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 text-sm px-4 py-2 overflow-x-auto whitespace-nowrap z-40 m-0 border-t border-gray-200 dark:border-gray-600">
