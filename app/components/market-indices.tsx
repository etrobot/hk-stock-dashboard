...
export function MarketIndices({ indices, showBackground = true, onIndexClick, onUpgradeClick }: MarketIndicesProps) {
  return (
    <>
      <div className="flex gap-4 px-3 py-2 overflow-x-auto bg-transparent w-full">
        ...
        <div className="fixed flex justify-between left-16 right-0 bottom-0 bg-card text-card-foreground text-xs px-4 py-2 overflow-x-auto whitespace-nowrap z-40 m-0 border-t border-border">
          <div>
        ...
        >
          港股行情延时15分钟，美股行情延时15分钟，点击升级高级行情
        </div>
        </div>
    </>
  )
