...
import { Eye, User, Info, Search } from 'lucide-react';
import { 
  accountOverview, 
  assetBreakdown, 
  currencyBreakdown, 
    ...
    <div className="min-h-screen bg-[#FFFFFF] text-black">
      ...
      <div className="bg-[#11131B] min-h-[calc(100vh-30px)] p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {/* Total Assets Card */}
          <Card className="bg-transparent border border-[#9FA0A9]">
        ...
        <div className="w-full">
          <div className="space-y-4">
            ...
            {/* Asset Cards */}
              <div className='flex gap-2'>
                {/* Asset Breakdown */}
                <Card className="bg-transparent border border-[rgba(75,82,105,0.5)] min-w-96">
                ...
                <Button
                  ...
                  className={`text-xs h-[18px] px-2 rounded-[3px] border ${
                    period.active || selectedPeriod === period.value
                      ? 'bg-[#FF5C00] bg-opacity-50 border-transparent'
            ...
            {/* Chart Container */}
            <Card className="bg-transparent border-0 h-full mt-6">
